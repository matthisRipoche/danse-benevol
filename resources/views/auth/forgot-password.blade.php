...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Mot de passe oublié — {{ config('app.name', 'Laravel') }}</title>
            ...
            <main class="w-full max-w-md rounded-2xl border border-sand-200 bg-white p-6 shadow-[0_2px_6px_-1px_rgba(92,25,17,0.04),0_1px_3px_-1px_rgba(92,25,17,0.02)]">
                <div class="relative mb-6 overflow-hidden rounded-xl bg-brand-600 p-6 text-white">
                    ...
                    <div class="relative flex flex-col gap-1">
                        ...
                        <h1 class="font-heading text-2xl font-bold">Mot de passe oublié</h1>
                        <p class="text-sm text-white/80">Indique ton adresse e-mail : tu recevras un lien pour choisir un nouveau mot de passe.</p>
                    </div>
                </div>
                ...
                <p class="mt-6 text-center text-sm text-stone-600">
                    <a href="{{ route('login') }}" class="font-semibold text-brand-500 hover:underline">Retour à la connexion</a>
                </p>
            </main>
        </div>
    </body>
