...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traduction française des messages de validation de Laravel. Les messages
    | propres à un formulaire restent définis dans son FormRequest.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'La valeur du champ :attribute est apparue dans une fuite de données : choisis-en une autre.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Remplacent « :attribute » dans les messages : « Le champ mot de passe… »
    | plutôt que « Le champ password… ».
    |
    */
    ...
    'attributes' => [
        ...
        'photo' => 'photo',
        'is_minor' => 'moins de 18 ans',
        'name' => 'nom',
        'description' => 'description',
        'is_public' => 'visibilité',
        'default_capacity' => 'nombre de places',
        'date' => 'date',
